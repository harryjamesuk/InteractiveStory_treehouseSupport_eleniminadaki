...
public class Story {
    ...
    // TODO: This could probably be refactored in some way. Code repetition!
    // Perhaps use a for loop and separate the scripts into another class.
    // Mipmaps may be quite difficult to use however, a case statement would work but
    // isn't very flexible if a new page is added...

    // Maybe a PageBuilder class to separate this work?

    // TODO: You should update the button labels.
    ...
    public Story() {
        ...
        mPages[mPageNumber] = new Page(mPageNumber,
                ...
                new Choices(mPageNumber, "[PREV] Explore the cave", "[NEXT] Explore the rover"));
        ...
        mPages[mPageNumber] = new Page(mPageNumber,
                ...
                new Choices(mPageNumber, "[PREV] Head back to Mars to investigate", "[NEXT] Continue home to Earth"));
        ...
        mPages[mPageNumber] = new Page(mPageNumber,
                ...
                new Choices(mPageNumber, "[PREV] Refill at ship and explore the rover", "[NEXT] Continue towards the faint light"));
        ...
        mPages[mPageNumber] = new Page(mPageNumber,
                ...
                new Choices(mPageNumber, "[PREV] Explore the coordinates", "[NEXT] Return to Earth"));
